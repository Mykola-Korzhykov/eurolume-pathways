    ...
    <section className={styles.wrapper} id="projects">
      <div className="container">
        <h1 className={styles.title}>
          Bringing Light to Life <span>Projects</span> and{" "}
        ...
        <div className={styles.row}>
          <div className={styles.left}>
            ...
            >
              <Image
                ...
                blurDataURL="/img/projects/project.jpg"
                alt="Projects"
                layout="fill"
              />
            </div>
          ...
          <div className={styles.right}>
            ...
            <div className={styles.leftImage}>
              <Image
                src="/img/projects/inspiration.jpg"
                blurDataURL="/img/projects/inspiration.jpg"
                alt="Inspirations"
                layout="fill"
              />
            </div>
            <Link href="/inspirations" className={styles.more}>
              See More
            </Link>
          </div>
        </div>
